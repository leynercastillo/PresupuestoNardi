...
-- Started on 2013-04-01 16:49:41
...
SELECT pg_catalog.setval('budget_id_budget_seq', 40, true);
...
SELECT pg_catalog.setval('budget_number_seq', 40, true);
...
SELECT pg_catalog.setval('business_partner_id_business_partner_seq', 36, true);
...
--
-- TOC entry 1888 (class 0 OID 18014)
-- Dependencies: 151
...
INSERT INTO basic_data VALUES (166, 'BUDGET', 'SISTEL', 'HALL BUTTON TYPE', false, 3, '/resource/images/system/sistel.png', 'A', NULL);


--
-- TOC entry 1889 (class 0 OID 18022)
...
--
-- TOC entry 1886 (class 0 OID 18001)
-- Dependencies: 148
...
INSERT INTO security_user VALUES (9, 'Maria A. Carrasco', 'ventas@ascensoresnardi.com', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '0414-5054777', 'A');


--
-- TOC entry 1890 (class 0 OID 18032)
...
--
-- TOC entry 1884 (class 0 OID 17988)
-- Dependencies: 145
...
--
-- TOC entry 1887 (class 0 OID 18007)
...
--
-- TOC entry 1883 (class 0 OID 17980)
-- Dependencies: 143
...
--
-- TOC entry 1885 (class 0 OID 17994)
...
-- Completed on 2013-04-01 16:49:41
