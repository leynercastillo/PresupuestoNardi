...
public class FrmQuotation {
	...
	public void loadPayment() {
		if (quotation.isType() && quotation.getBasicDataByQuotationType().getName().contains("MONEDA NACIONAL")) {
			...
			quotation.setQuotationValidity("07");
			quotation.setNotes("- Los precios señalados no incluyen el IVA.\n" + "- Queda entendido que el no cumplimiento de los plazos y cuotas establecidos para la adiquisición del equipo traerá como consecuencia el atraso del envío del equipo al país por parte del proveedor.\n" + "- Cuota de Nacionalización: De existir atraso en la cancelación de esta cuota, generará gastos por concepto de aranceles de demora, almacenamiento, multas, etc, los cuales serán cancelados únicamente por parte del cliente.\n" + "- El precio de (los) equipo(s) NO INCLUYE el valor por concepto de mano de obra de DESMONTAJE y MONTAJE. Este precio será estimado al momento de comenzar la instalación del (los) equipo(s) y podrá variar en el transcurso  del mismo por causas ajenas a la empresa.\n" + "- En caso de daño oculto será presupuestado al momento de ser detectado y por separado.\n" + "- Las cuotas del material importado han sido calculadas al tipo de cambio oficial del momento, por lo tanto, cualquier variación que exista en el tipo de cambio sera calculado al momento de efectuarse el pago.\n" + "- El valor del equipo ha sido calculado al tipo de cambio oficial al momento de la negociación, por lo tanto, cualquier variación que exista en el tipo de cambio será calculado al momento de efectuarse el pago de la cuota.\n" + "- El incumplimiento en el pago de las cuotas genera intereses de mora.\n" + "- La empresa no se hace responsable de la contribucion o pagos al sindicato de la construccion, ni a ningun otro sindicato.\n" + "- Este presupuesto no contempla gastos de fianzas de ninguna indole.");
			quotation.setPriceImportedMaterial(0);
			quotation.setPriceNationalMaterial(0);
			quotation.setTotalPrice(0);
